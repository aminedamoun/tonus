...
export default function InstagramFeed() {
  const instagramPosts = [
    ...
    {
      id: 2,
      image: '/assets/images/homepage/insta-souvlaki.webp',
      alt: 'Grilled souvlaki skewers with vegetables',
      likes: 312,
    },
    {
      id: 3,
      image: '/assets/images/homepage/insta-moussaka.webp',
      alt: 'Traditional Greek moussaka dish',
      likes: 198,
    },
    {
      id: 4,
      image: '/assets/images/homepage/insta-seafood.webp',
      alt: 'Fresh Mediterranean seafood platter',
      likes: 421,
    },
    {
      id: 5,
      image: '/assets/images/homepage/insta-baklava.webp',
      alt: 'Delicious baklava dessert with honey',
      likes: 356,
    },
    {
      id: 6,
      image: '/assets/images/homepage/insta-interior.webp',
    ...
    <section className="py-20 bg-muted/30">
      <div className="container-custom">
        ...
        <div className="text-center mb-12 reveal">
          ...
          <h2 className="text-4xl md:text-6xl font-serif italic text-foreground mb-4"></h2>
