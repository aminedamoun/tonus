...
export default function LocationMap() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative rounded-3xl md:rounded-[48px] overflow-hidden border-2 border-primary/40 transition-all duration-500 hover:border-primary/60 hover:shadow-blue-glow-lg h-[300px] md:h-[500px]">
        {isHydrated && (
          <iframe
