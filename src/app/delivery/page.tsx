...
const deliveryPartners = [
{
  ...
  logo: 'https://698ef95f42985dd050940011.imgix.net/talabat.webp',
  ...
  return (
    <>
      ...
      <main className="pt-32 pb-20 overflow-x-hidden">
        ...
        <section className="container-custom mb-20 reveal">
          <div className="relative">
            ...
            <div
              ...
              style={{ background: 'radial-gradient(circle, #89CFF0 0%, transparent 70%)', transform: 'translate(30%, -30%)' }} />
            ...
            <div className="absolute bottom-0 left-0 pointer-events-none select-none" aria-hidden="true">
              ...
              <div className="absolute w-2.5 h-2.5 rounded-full" style={{ background: '#89CFF0', opacity: 0.5, top: '0px', left: '40px', animation: 'floatDot 4s ease-in-out infinite' }} />
              <div className="absolute w-2 h-2 rounded-full" style={{ background: '#1E3A5F', opacity: 0.2, top: '50px', left: '10px', animation: 'floatDot 5.5s ease-in-out infinite 1s' }} />
              <div className="absolute w-3 h-3 rounded-full" style={{ background: '#89CFF0', opacity: 0.35, top: '70px', left: '80px', animation: 'floatDot 3.8s ease-in-out infinite 0.5s' }} />
            </div>

            {/* Floating decorative dots - top right */}
            <div className="absolute top-0 right-8 pointer-events-none select-none" aria-hidden="true">
              <div className="absolute w-2 h-2 rounded-full" style={{ background: '#89CFF0', opacity: 0.4, animation: 'floatDot 4.5s ease-in-out infinite' }} />
              <div className="absolute w-1.5 h-1.5 rounded-full" style={{ background: '#1E3A5F', opacity: 0.2, top: '20px', left: '15px', animation: 'floatDot 6s ease-in-out infinite 1.5s' }} />
              <div className="absolute w-3 h-3 rounded-full" style={{ background: '#89CFF0', opacity: 0.25, top: '40px', left: '-5px', animation: 'floatDot 5s ease-in-out infinite 0.8s' }} />
            </div>
            ...
            <div className="text-center space-y-6 max-w-3xl mx-auto relative z-10 py-8">
              ...
              <h1 className="text-6xl md:text-8xl font-serif italic text-foreground leading-tight">
                Fresh Greek Flavors.<br />
                <span className="text-primary">Delivered to Your Door.</span>
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Authentic Mediterranean cuisine crafted with love, packaged with care, and delivered straight to you — hot, fresh, and on time.
              </p>
        ...
        <section className="section-padding bg-white reveal">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div
                key={card.id}
                className="floating-card p-8 text-center space-y-4">
                
                  <div
                  className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto"
                  style={{ background: 'rgba(137,207,240,0.15)', border: '2px solid rgba(137,207,240,0.3)' }}>
        ...
        {/* ── 4. PREMIUM PACKAGING ────────────────────────────────────────── */}
        <section className="section-padding reveal" style={{ background: 'linear-gradient(135deg, #1E3A5F 0%, #0f2240 100%)' }}>
          <div className="container-custom">
            <div
              ...
              <div
                ...
                style={{
                  backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 20px, rgba(137,207,240,0.5) 20px, rgba(137,207,240,0.5) 40px)'
                }} />
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                <div
                  ...
                  style={{ background: 'rgba(137,207,240,0.15)', border: '2px solid rgba(137,207,240,0.4)' }}>
                  
                  <Icon name="GiftIcon" size={40} className="text-primary" />
                </div>
                <div className="text-center md:text-left">
                  <div className="inline-block pill-badge mb-4" style={{ background: 'rgba(137,207,240,0.2)', color: '#89CFF0', border: '1px solid rgba(137,207,240,0.4)' }}>
                    Premium Quality
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3 mt-6 justify-center md:justify-start">
                    ...
                    <span
                      ...
                      style={{ background: 'rgba(137,207,240,0.12)', border: '1px solid rgba(137,207,240,0.3)' }}>
        ...
        <section className="section-padding bg-white reveal">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 max-w-3xl mx-auto">
              ...
              <div
                key={method.id}
                className="floating-card p-6 text-center space-y-3">
                
                  <div
                  className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto"
                  style={{ background: 'rgba(137,207,240,0.12)', border: '2px solid rgba(137,207,240,0.25)' }}>
                  
                    <Icon name={method.icon} size={26} className="text-primary" />
                  </div>
                  <p className="text-sm font-semibold text-foreground leading-tight">{method.label}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="container-custom">
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{ background: 'linear-gradient(90deg, transparent, rgba(137,207,240,0.5) 20%, rgba(137,207,240,0.5) 80%, transparent)' }} />
                ...
                <div
                  ...
                  style={{ transitionDelay: `${i * 0.12}s` }}>
                    ...
                    <div className="relative">
                      ...
                      style={{
                        background: 'linear-gradient(135deg, rgba(137,207,240,0.2) 0%, rgba(30,58,95,0.1) 100%)',
                    ...
                    {i < steps.length - 1 &&
                  <div className="lg:hidden w-px h-6 bg-primary/30" />
                  }
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      background: 'radial-gradient(circle, rgba(137,207,240,0.25) 0%, transparent 70%)',
                    ...
                    <div className="space-y-3 px-2">
                      ...
                      <div className="bg-white/10 rounded-full h-2">
                        <div
                          ...
                          style={{ width: '65%', background: 'linear-gradient(90deg, #89CFF0, #1E3A5F)' }} />
                      ...
                      <div key={s.label} className="flex items-center gap-3">
                          ...
                          style={{ color: s.active ? '#89CFF0' : s.done ? 'rgba(255,255,255,0.8)' : 'rgba(255,255,255,0.4)' }}>
                      ...
                      <div
                        ...
                        style={{ background: 'rgba(137,207,240,0.1)', border: '1px solid rgba(137,207,240,0.2)' }}>
        ...
        <section className="section-padding greek-pattern-bg reveal">
          <div className="container-custom">
            <div
              ...
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto" style={{ background: 'rgba(137,207,240,0.15)', border: '2px solid rgba(137,207,240,0.3)' }}>
              ...
              <p className="text-lg text-white/75 max-w-xl mx-auto">
                Authentic Greek flavors are just a few taps away. Order now and experience the taste of the Mediterranean at home.
              </p>
