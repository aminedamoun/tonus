        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
          <tr>
            <td style="background:linear-gradient(135deg,#1E3A5F,#2a4a6f);padding:32px 40px;text-align:center;">
              ...
              <p style="margin:6px 0 0;color:#89CFF0;font-size:13px;letter-spacing:2px;text-transform:uppercase;">New Contact Message</p>
            </td>
          </tr>
          <tr>
            <td style="padding:36px 40px;">
              <p style="margin:0 0 24px;color:#6b7280;font-size:14px;line-height:1.6;">You have received a new message from the contact form on your website.</p>
                ...
                <tr>
                  <td style="padding:24px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      ${phone ? `<tr><td style="padding:8px 0;border-bottom:1px solid #e0f2fe;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;">
                <tr><td align="center">
                  <a href="mailto:${email}?subject=Re: Your message to Tono's" style="display:inline-block;background-color:#89CFF0;color:#1a1a1a;padding:14px 32px;border-radius:50px;font-size:14px;font-weight:700;text-decoration:none;letter-spacing:0.5px;">Reply to ${name}</a>
                </td></tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="background-color:#f8fafc;padding:20px 40px;text-align:center;border-top:1px solid #e5e7eb;">
              <p style="margin:0;color:#9ca3af;font-size:12px;">This email was sent from the contact form at tonosdxb.com</p>
            </td>
          </tr>
        </table>
      </td>
