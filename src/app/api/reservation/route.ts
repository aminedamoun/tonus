          ...
          <tr>
            <td style="padding:36px 40px;">
              <p style="margin:0 0 24px;color:#6b7280;font-size:14px;line-height:1.6;">
                A new reservation has been made through your website.
              </p>
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="50%">
                                ...
                                <span style="color:#1a1a1a;font-size:15px;font-weight:600;text-transform:capitalize;">${seatingArea === 'non-smoking' ? 'Non-Smoking' : 'Smoking'}</span>
                              </td>
                              <td width="50%">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;">
                <tr>
                  <td align="center">
                    <a href="mailto:${email}?subject=Your Reservation at Tono's - ${formattedDate} at ${time}" style="display:inline-block;background-color:#89CFF0;color:#1a1a1a;padding:14px 28px;border-radius:50px;font-size:14px;font-weight:700;text-decoration:none;letter-spacing:0.5px;margin:0 6px;">
                      Email Guest
                    </a>
                    <a href="tel:${phone}" style="display:inline-block;background-color:#1E3A5F;color:#ffffff;padding:14px 28px;border-radius:50px;font-size:14px;font-weight:700;text-decoration:none;letter-spacing:0.5px;margin:0 6px;">
                      Call Guest
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="background-color:#f8fafc;padding:20px 40px;text-align:center;border-top:1px solid #e5e7eb;">
              <p style="margin:0;color:#9ca3af;font-size:12px;">
                This reservation was made through tonosdxb.com
              </p>
            </td>
          </tr>
